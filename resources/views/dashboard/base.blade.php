...
<div class="content-body">
    <!-- <div class="form-head" style="background-image:url('{{ asset('images/background/bg3.jpg') }}');background-position: bottom; ">
            ...
            <div class="col-xl-3 col-sm-6 m-t35">
                <div class="card card-coin">
                    <div class="card-body text-center">
                        ...
                        <h2 class="text-black mb-2 font-w600">{{ $user }}</h2>
                        <p class="mb-0 fs-14"></span>Total Users
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-sm-6 m-t35">
                <div class="card card-coin">
                    <div class="card-body text-center">
                        ...
                        <h2 class="text-black mb-2 font-w600">{{ $post }}</h2>
                        <p class="mb-0 fs-14">
                            Total Post
                        </p>
                    </div>
            ...
            <div class="col-xl-3 col-sm-6 m-t35">
                <div class="card card-coin">
                    <div class="card-body text-center">
                        ...
                        <h2 class="text-black mb-2 font-w600">{{ $report }}</h2>
                        <p class="mb-0 fs-14">Total report
                        </p>
                    </div>
                </div>
            </div>
