            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('index.create.admin')}}" class="btn btn-rounded btn-outline-primary">+ data
                            admin</a>
                            ...
                            <table id="example3" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('index.edit.admin', $row->id) }}" class="btn btn-primary shadow btn-xs sharp mr-1"><i
                                                ...
                                                <form id="delete-form-{{ $row->id }}" action="{{ route('index.delete.user') }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
